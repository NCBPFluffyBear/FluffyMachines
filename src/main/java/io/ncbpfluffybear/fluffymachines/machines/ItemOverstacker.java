...
public class ItemOverstacker extends SlimefunItem implements InventoryBlock, EnergyNetComponent {
    ...
    private static final ItemStack[] stackableItems = {new ItemStack(Material.DIAMOND_PICKAXE),
    ...
    protected void setupInv() {
        createPreset(this, "&eItem Overstacker", preset -> {
            ...
            for (int i : INPUT_BORDER) {
                preset.addItem(i, new CustomItem(new ItemStack(Material.LIGHT_BLUE_STAINED_GLASS_PANE), " "),
                    (p, slot, item, action) -> false
                );
            }
            ...
            preset.addItem(PROCESSING_SLOT, new CustomItem(new ItemStack(Material.BLACK_STAINED_GLASS_PANE), " "),
                (p, slot, item, action) -> false
            );
        });
    }
                    ...
                    if (validItem.getItemMeta().equals(inputSlotItem.getItemMeta())) {
                        ...
                        for (int outputSlot : OUTPUT_SLOTS) {
                            ...
                            if (outputSlotItem != null &&
                                ...
                                finalOutputItem = new ItemStack(outputSlotItem.getType(),
                                    outputSlotItem.getAmount() + inputSlotItem.getAmount());
                            }
