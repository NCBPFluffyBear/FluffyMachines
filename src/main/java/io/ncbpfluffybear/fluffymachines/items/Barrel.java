...
public class Barrel extends NonHopperableBlock implements DoubleHologramOwner {
            ...
            public void newInstance(@Nonnull BlockMenu menu, @Nonnull Block b) {
                ...
                if (BlockStorage.getLocationInfo(b.getLocation(), "stored") == null) {
                    ...
                    menu.replaceExistingItem(STATUS_SLOT, new CustomItemStack(
                            Material.LIME_STAINED_GLASS_PANE, "&6Items Stored: &e0" + " / " + barrelCapacity.getValue(), "&70%"));
    ...
    public void updateMenu(Block b, BlockMenu inv, boolean needsViewer) {
        ...
        if (inv.hasViewer() || needsViewer) {
            inv.replaceExistingItem(STATUS_SLOT, new CustomItemStack(
                    Material.LIME_STAINED_GLASS_PANE, "&6Items Stored: &e" + stored + " / " + barrelCapacity.getValue(),
    ...
    public enum BarrelType {
        ...
        SMALL(17280000, "&eSmall Fluffy Barrel", Material.BEEHIVE),
        MEDIUM(34560000, "&6Medium Fluffy Barrel", Material.BARREL),
        BIG(69120000, "&bBig Fluffy Barrel", Material.SMOKER),
        LARGE(138240000, "&aLarge Fluffy Barrel", Material.LODESTONE),
        MASSIVE(276480000, "&5Massive Fluffy Barrel", Material.CRYING_OBSIDIAN),
        BOTTOMLESS(1728000000, "&cBottomless Fluffy Barrel", Material.RESPAWN_ANCHOR);
